package live.hestia.app.EventDetailed;
...
import live.hestia.app.Adapter.ParticipantListAdapter;
...
//        progress.setCancelable(false);
    ...
    private void registerEvent() {
        if (!isNetworkConnected()) {
            errorOccurred(getString(R.string.network_error), 1);
            return;
        }
...
//                        progress.dismiss();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        errorOccurred(getString(R.string.network_error), 2);
                    }
                });
    ...
    private void errorOccurred(final String msg, final int i) {
